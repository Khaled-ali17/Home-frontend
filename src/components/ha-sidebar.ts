...
class HaSidebar extends SubscribeMixin(LitElement) {
  ...
  private _renderHeader() {
    ...
    >
      ...
      ${this.editMode
        ...
        : html`<div class="title">Eureka Lite</div>`}
    </div>`;
  }
  ...
  private _renderNotifications() {
    ...
    >
      ...
      >
        <ha-svg-icon slot="item-icon" .path=${mdiAccountVoice}></ha-svg-icon>
    ...
    return [
      ...
      css`
        ...
        a.iron-selected paper-icon-item ha-svg-icon {
          color: var(--table-row-alternative-background-color);
        }
